...
- ❄️ **Snowflake** (Snowpark, Snowpipe, Streams & Tasks)  
- 🧱 **dbt Cloud/Core**  
- ☁️ **AWS S3** (external stages & storage options)  
...
- ⏱️ Calculate **loan processing time** (e.g., days between agreement signing and repayments).  
